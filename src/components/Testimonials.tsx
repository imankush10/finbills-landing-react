...
const testimonials = [
  {
    ...
    content: "BusinessPro has transformed how we operate. The efficiency gains are remarkable.",
  ...
  },
  {
    ...
    content: "The best business management platform we've ever used. Worth every penny.",
